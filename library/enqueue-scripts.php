...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	function foundationpress_scripts() {
		...
		// Lightbox Script
		wp_enqueue_script( 'lightbox-js', get_template_directory_uri() . '/lightbox2/dist/js/lightbox.min.js', array(), null, true );
		...
		wp_enqueue_style( 'slick-css',  get_template_directory_uri() . '/slick/slick.css', array(), null, 'all' );

		// Enqueue the Lightbox Stylesheet.
		wp_enqueue_style( 'lightbox-css',  get_template_directory_uri() . '/lightbox2/dist/css/lightbox.min.css', array(), null, 'all' );
